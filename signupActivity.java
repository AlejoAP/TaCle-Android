...
public class signupActivity extends AppCompatActivity {
    ...
    public void SubmitData2SQLiteDB(){
        ...
        if(CheckEditTextEmpty)
        {
            ...
            Toast.makeText(this,"Enregistré avec succés", Toast.LENGTH_LONG).show();
    ...
    public void CheckEditTextIsEmptyOrNot( String lnm,String fnm,String eid , String pwd){ //vérifier les champs vides
